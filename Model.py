...
ar_bad_words = []
with open("ar_profan_words.txt", 'r',encoding='utf-8') as file:
    content = file.read()
ar_bad_words = content.split(",")
#remove the " from the list
ar_bad_words=[item.strip(" '") for item in ar_bad_words]
#print(ar_bad_words)
#remove lastitem from list bad_words , to remove the /n string
#ar_bad_words.pop()
print(ar_bad_words)
...
en_bad_words = []
with open("en_profan_words.txt", 'r',encoding='utf-8') as file:
    content = file.read()
en_bad_words = content.split(",")

#remove the " from the list
en_bad_words=[item.strip(" '") for item in en_bad_words]
#print(en_bad_words)
#remove lastitem from list bad_words , to remove the /n string
#en_bad_words.pop()
print(en_bad_words)
...
emoji_bad_words = []
with open("emoji_profan_words.txt", 'r',encoding='utf-8') as file:
    content = file.read()
emoji_bad_words = content.split(",")

#remove the " from the list
emoji_bad_words=[item.strip(" '") for item in emoji_bad_words]
...
"""
text="اح"
if text in ar_bad_words :
    print("Yeeeeeees")
"""

"""
text="kos"
if text in en_bad_words :
    print("Yeeeeeees")
